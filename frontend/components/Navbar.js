    ...
    <Popover className="relative ">
      <div className="max-w-8xl mx-auto px-4 sm:px-6">
        <div className="hidden justify-start md:flex lg:hidden lg:w-0 lg:flex-1">
            <a className="flex flex-row justify-center items-center " href="/">
              ...
              <div className="flex flex-col text-xs ml-3 md:ml-2 md:mt-2">
                <span className="text-gray-900 font-bold">Job Fair 2023</span>
                <span className="text-gray-500 ">Assam University Silchar</span>
              </div>
            </a>
          </div>
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:py-2 lg:py-6 md:justify-start md:space-x-10">
          ...
          <a href="/InstituteLogin" className="text-base font-medium text-gray-500 hover:text-gray-900">
              Institute Login
          </a>
          <a href="/OfficerLogin" className="text-base font-medium text-gray-500 hover:text-gray-900">
              Officer Login
          </a>
          </Popover.Group>

          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">  
            <a href="/Login" className="whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white  bg-brightRed hover:bg-brightRedLight"
            >
              Login
            </a>
          </div>
            ...
            <div className="py-6 px-5 space-y-6 bg-veryPaleRed">
              ...
              <div>
                ...
                <p className="mt-6 text-center text-base font-medium text-gray-500">
                  New Student?{' '}
                  <a href="/RegistrationInstruction" className="text-brightRed hover:text-brightRedLight">
                    Register Here
                  </a>
                </p>
              </div>
